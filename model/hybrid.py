...
config = Config()
config.MODEL_PATH = 'D:/MyEclipseProject/CPSC_Scheme-master/Net_models/'
config.MAN_FEATURE_PATH = 'D:/MyEclipseProject/CPSC_Scheme-master/Man_features/'
...
np.save(config.MAN_FEATURE_PATH + 'lb_t.npy', lb_t)
np.save(config.MAN_FEATURE_PATH + 'pred_v.npy', pred_v)
np.save(config.MAN_FEATURE_PATH + 'pred_t.npy', pred_t)
